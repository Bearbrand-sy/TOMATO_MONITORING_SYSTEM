...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2026 at 01:43 AM
...
(1, 'sander', 'sander@example.com', 'password123', 'admin');
...
INSERT INTO `manager` (`manageID`, `name`, `email`, `password`, `role`) VALUES
(1, 'trisha', 'trisha@example.com', 'password123', 'manager');
...
(1, 'pauline', 'pauline@example.com', 'password123', 'user');
